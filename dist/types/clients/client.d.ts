...
export class Client {
    ...
    get(resource: any): Promise<module>;
    /**
     * Patches a resource.
    ...
    put(resource: any, body: any): Promise<module>;
    post(resource: any, body: any): Promise<module>;
    /**
     * Deletes a resource.
     ...
     */
    request<T>(method: string, uri: string, ...args: any[]): Promise<module>;
    requestAll(method: any, uri: any, ...args: any[]): Promise<any[]>;
